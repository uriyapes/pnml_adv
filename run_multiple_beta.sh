...
beta_arr=(0 0.0005 0.001 0.005 0.01 0.033 0.066 0.1 0.25 0.36 0.5 0.66 0.8 1)
...
do
    ...
    CUDA_VISIBLE_DEVICES=$cuda_device python ./src/main.py -t $exp_name -b ${beta_arr[idx]} -o output/mnist_beta_search &
    sleep 2
done
cuda_device=$((first_cuda_device_index + idx))
CUDA_VISIBLE_DEVICES=$cuda_device python ./src/main.py -t $exp_name -b ${beta_arr[idx]} -o output/mnist_beta_search