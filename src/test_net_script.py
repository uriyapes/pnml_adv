...
def train_model(experiment_type: str):
    ...
    model_trained, train_loss, test_loss = train_class.train_model(model_base, dataloaders,
    ...
    return test_loss, test_acc, model_trained


# model_trained = train_model('mnist_adversarial')
# print(test_acc)
